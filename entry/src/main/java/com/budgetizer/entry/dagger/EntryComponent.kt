...
import com.budgetizer.entry.ui.EntryActivity
import dagger.Component

@Component(
    modules = [EntryModule::class],
...
interface EntryComponent {
    ...
    @Component.Builder
    interface Builder {
        fun entryDataModule(entryDataModule: EntryDataModule): Builder
        fun entryModule(entryModule: EntryModule): Builder
        fun coreComponent(module: CoreComponent): Builder
        fun build(): EntryComponent
    }

    fun inject(into: EntryActivity)
}
